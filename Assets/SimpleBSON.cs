...
namespace Kernys.Bson
{
	...
	//#TODO: the following two disable the warnings:
	//Kernys.Bson.BSONValue' defines operator == or operator != but does not override Object.Equals(object o)
	//Kernys.Bson.BSONValue' defines operator == or operator != but does not override Object.GetHashCode()
	//note that we re-enable the warning at the end of the class declaration.
	...
	public class BSONValue
	{
		...
		*/
		...
		{
            // What the hell is this? Why is this here? I'm taking it out - RL jan2014
            /*
			if (b == null)
				return true;
            */
